...
#AK6992,Huawei,GUJ002H__Ferozeabad_GUJ_2,AAK6992__S_JanubiChowk,AAK16992__S_JanubiChowk,12/10/2014 15:11:04,12/10/2014 16:34:44
 # 1      2            3                     4                    5                        6                  7  
  ...
  # print "$cl ";  
   ...
   # $ddd[2]="20" . $ddd[2];
    ...
    # print "$Fld1|$Fld2|$Fld3|$Fld4|$dt\n" ;
     print "$Fld2~$Fld3~$Fld4~$dd[0]/$dd[1]/$dd[2]|$dt\n" ;
